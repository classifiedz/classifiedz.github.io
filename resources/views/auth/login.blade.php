                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('emailRegister') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="emailRegister" type="email" class="form-control" name="emailRegister"
                                           value="{{ old('emailRegister') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('passwordRegister') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="passwordRegister" type="password" class="form-control"
                                           name="passwordRegister" required>
                            ...
                            <div class="form-group">
                                <label for="passwordRegister-confirm" class="col-md-4 control-label">Confirm
                                    Password</label>

                                <div class="col-md-6">
                                    <input id="passwordRegister-confirm" type="password" class="form-control"
